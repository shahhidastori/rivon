...
export function PublicHeader() {
  ...
  return (
    <header className="public-header">
      <Link to="/" className="brand-mark" aria-label="Rivon home">
  ...
  return (
    <footer className="public-footer">
      <div className="footer-brand">
        <img className="footer-logo-image" src={rivonLogo} alt="Rivon Resort logo" />
        <span className="footer-logo">Rivon</span>
